...
/**
 * Vx' core object which orchestrates all other activity.
 * @constructor
...
Kernel.prototype.logger = function () {
  ...
  return {
    info: log.info('vx', colorize),
    warn: log.warn('vx', colorize),
    debug: log.debug('vx', colorize),
    error: log.error('vx', colorize)
  };
};
...
Kernel.prototype.usage = function () {
  ...
  console.log('Usage: vx [command] [arguments]\n');
  console.log('Options:');
